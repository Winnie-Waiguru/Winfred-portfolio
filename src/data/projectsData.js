...
export const projects = [
  {
    ...
    learnings:
      "Learnt how to structure a project into components, work with APIs to fetch and display data dynamically, manage state in a React application, use localStorage to persist data without authentication, style an app using Tailwind CSS, and deploy a project to a live environment with Vercel.",
  },
  {
    id: 2,
    image: {
  ...
  },
  {
    ...
    description:
      "Meal Health App is a full-stack web application developed in collaboration with my friends. The app replaces paper-based meal tracking with a digital solution, enabling users to create profiles, log meals with nutritional data, and track the meals they are supposed to eat by the end of the day. I am contributing by working on both the frontend and backend development.",
